...
enum AppAction {
    ...
    case cloudUploadRequest(token: CloudUploadTokenResponse.Result, md5: String, size: Int, data: Data)
    case cloudUploadCheckRequest(fileURL: URL)
    case cloudUploadCheckRequestDone(result: Result<(fileURL: URL, md5: String), AppError>)
