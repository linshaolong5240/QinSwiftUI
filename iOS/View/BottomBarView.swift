        ...
        ZStack {
            HStack {
                ZStack {
                    ...
                    NEUCircleButtonView(systemName: player.isPlaying ? "pause" : "play.fill", size: .small, active: true)
                        .onTapGesture{
                ...
                Spacer()
                    //                        NeuCircleButtonView(systemName: "backward.fill", size: .small, active: false, action: {
                    //                            Store.shared.dispatch(.playBackward)
                    //                        })
                NEUCircleButtonView(systemName: "forward.fill", size: .medium, active: false).onTapGesture{
